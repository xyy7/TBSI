...
def main():
    ...
    if args.mode == "single":
        train_cmd = (
            ...
            % (args.script, args.config, args.save_dir, args.use_lmdb, args.script_prv, args.config_prv, args.distill, args.script_teacher, args.config_teacher, args.use_wandb)
        )
    ...
    if args.debug:
        train_cmd = train_cmd.replace("python", "python -m debugpy --wait-for-client --listen 5678")
    os.system(train_cmd)
