...
def run_training(
    ...
    settings = ws_settings.Settings()  # 准备好相对应的文件夹
    ...
    settings.cfg_file = os.path.join(prj_dir, "experiments/%s/%s.yaml" % (script_name, config_name))  # 读取配置文件
...
def main():
    ...
    parser.add_argument("--script_prv", type=str, default=None, help="Name of the train script of previous model.")  # 先前的训练脚本
    parser.add_argument("--config_prv", type=str, default=None, help="Name of the config file of previous model.")  # 先前的配置脚本
